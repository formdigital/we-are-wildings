    ...
    <div class="py-6 container no-gutters">
        <div class="row justify-center">
            <div class="col-12 articleHero">
                <h1 class="serif font-size-3xl uppercase text-center text-block-20">Our first Shepherds Hut now available for booking</h1>
                <div class="articleDetails text-center">
                    <div class="category">Journal</div>
                    <div class="date">11 Jul 2024</div>
                </div>
            </div>
            <div class="col-12 col-lg-11 col-xl-10 articleHeroImage">
...
<div class="px-1 overflow-hidden bt-light">
    <div class="pt-4 pb-3 text-center">
        <h2 class="subheading uppercase font-size-sm">Related Articles</h2>
    </div>
