(self["webpackChunkmix_webpack_starter"] = self["webpackChunkmix_webpack_starter"] || []).push([["/js/vendor"],{
...
class Core {
	...
	loadScripts(cachedScripts) {
		...
		for (let i = 0; i < currentScripts.length; i++) {
			for (let n = 0; n < newScripts.length; n++) {
				if (currentScripts[i].outerHTML === newScripts[n].outerHTML) {
					(0,_helpers__WEBPACK_IMPORTED_MODULE_1__.reloadElement)(currentScripts[i], 'SCRIPT')
		...
		for (const script of newScripts) {
			(0,_helpers__WEBPACK_IMPORTED_MODULE_1__.appendElement)(script, 'SCRIPT')
		}
	}
	...
	loadStyles(cachedStyles) {
		...
		for (let i = 0; i < currentInlineStyles.length; i++) {
			for (let n = 0; n < newInlineStyles.length; n++) {
				if (currentInlineStyles[i].outerHTML === newInlineStyles[n].outerHTML) {
					(0,_helpers__WEBPACK_IMPORTED_MODULE_1__.reloadElement)(currentInlineStyles[i], 'STYLE')
		...
		for (const style of newInlineStyles) {
			(0,_helpers__WEBPACK_IMPORTED_MODULE_1__.appendElement)(style, 'STYLE')
		}
	}
